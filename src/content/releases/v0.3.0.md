...
highlights:
  - 'Neu aufgebaute interaktive Karte (MapLibre GL)'
  - 'Bewässerungsgruppen-Übersicht als Karten-Raster'
  - 'Detailpanel für Bewässerungsgruppen auf der Karte'
  - 'Bodentyp- und altersbewusster Bewässerungsstatus'
  - 'Sensoren ohne QR-Code aktivieren'
changelog:
  - type: 'feat'
    scope: 'map'
